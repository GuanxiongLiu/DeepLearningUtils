...
######## parametric layers
def dense_layer(tensor_in, dim, act=None, reuse=None, name=None, init=None, b_init=None, reg=None):
...
def sigmoid_layer(tensor_in, name=None):
    return tf.nn.sigmoid(x=tensor_in, name=name)
