...
class CIFAR_GAN:
    ...
    def train(self):
        ...
        # save model
        save_path = self.saver.save(sess, './models/cifar-dcgan-save.ckpt')
    ...
    def evaluate(self, save_path):
        ...
        gen_img, real_pred, fake_pred, _ = sess.run(fetches=[self.N_gen_image, 
                                                    ...
                                                    feed_dict={self.Noise: fake, 
                                                               self.Image: real})
        # visualize
        self.visualize(gen_img, 'evaluation')
    ...
    def visualize(self, imgs, name):
        ...
        directory = './imgs/cifar_dcgan_save/'
...
if __name__ == '__main__':
    ...
    gan.train()
    # evaluate model
    gan.evaluate('./models/cifar-dcgan-save.ckpt')
